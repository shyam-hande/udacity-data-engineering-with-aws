...
AmazonS3_node1767185562717 = glueContext.create_dynamic_frame.from_catalog(database="stedi-db", table_name="customer_landing", transformation_ctx="AmazonS3_node1767185562717")
...
'''
SQLQuery_node1767167148165 = sparkSqlQuery(glueContext, query = SqlQuery2469, mapping = {"myDataSource":AmazonS3_node1767185562717}, transformation_ctx = "SQLQuery_node1767167148165")
