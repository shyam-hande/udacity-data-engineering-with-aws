...
AmazonS3_node1767185562717 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://shyam-hande/customer/landing/"], "recurse": True}, transformation_ctx="AmazonS3_node1767185562717")
...
'''
SQLQuery_node1767167148165 = sparkSqlQuery(glueContext, query = SqlQuery2122, mapping = {"myDataSource":AmazonS3_node1767185562717}, transformation_ctx = "SQLQuery_node1767167148165")
