...
AmazonS3_node1767173886833 = glueContext.create_dynamic_frame.from_catalog(database="stedi-db", table_name="step_trainer_landing", transformation_ctx="AmazonS3_node1767173886833")

# Script generated for node Amazon S3
AmazonS3_node1767173887794 = glueContext.create_dynamic_frame.from_catalog(database="stedi-db", table_name="customer_curated_3", transformation_ctx="AmazonS3_node1767173887794")
...
'''
SQLQuery_node1767173890822 = sparkSqlQuery(glueContext, query = SqlQuery2254, mapping = {"customers_curated_3":AmazonS3_node1767173887794, "step_trainer_landing":AmazonS3_node1767173886833}, transformation_ctx = "SQLQuery_node1767173890822")
